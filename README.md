...
The router is running in GNS3.
The management IP is correct.
The automation server has network connectivity to the router.
SSH is enabled on the router.
The Ansible username is correct.
The credentials are correct.
ansible_connection and ansible_network_os are configured correctly.
Available Playbooks
